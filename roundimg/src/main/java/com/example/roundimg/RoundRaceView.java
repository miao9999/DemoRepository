...
/**
 * Created by LiMiao on 2017/10/18.
 */

@SuppressLint("AppCompatCustomView")
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
class RoundRaceView extends ImageView {
    /**
     * 圆形模式
     */
    ...
    public RoundRaceView(Context context) {
        super(context);
        initViews();
    }

    public RoundRaceView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundRaceView(Context context, AttributeSet attrs, int defStyleAttr) {
